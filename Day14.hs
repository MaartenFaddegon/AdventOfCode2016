...
data HashCache = H String (IntMap (Maybe Char, Maybe Char))

ex0 = threeOfTheSame (hash "abc" 0x18)
ex1 = snd $ getHash (initCache "abc") 0x18
ex2 = snd $ getHash (initCache "abc") 0x39
ex3 = snd $ getHash (initCache "abc") 0x816
ex3' = snd $ search5 (initCache "abc") 0x39 1 'e'
ex4 = head $ searchKey (initCache "abc") 0
ex5 = (searchKey (initCache "abc") 0) !! 63

main = putStrLn solution1

solution1 = show k
  where
  k = (searchKey (initCache "ahsbgdzn") 0) !! 63
